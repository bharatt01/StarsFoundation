export default function AboutUsOverview() {
  return (
    <section className="max-w-7xl mx-auto mb-20 font-sans text-[#0757a0]">
      {/* Banner Image */}
      <div className="relative w-full h-80 md:h-96 rounded-3xl overflow-hidden shadow-2xl mb-16">
        <img
      ...
      {/* Text Content */}
      <div className="bg-white rounded-3xl shadow-xl p-12 md:p-20 max-w-4xl mx-auto leading-relaxed font-medium space-y-8">
       <h1 className="absolute bottom-6 text-4xl sm:text-5xl md:text-6xl font-extrabold text- drop-shadow-lg max-w-xl">
          Discover <span className="text-[#9ac531]">About Us</span>
        </h1>
        <p>
          <strong>Stars Foundation</strong> was established on <span className="font-semibold">28th May 2018</span> under the <em>Trust Registration Act 1882</em>. We are a national-level trust recognized under <span className="font-semibold">80G &amp; 12A</span>. Founded with the passion of <q>Devotion to the Nation</q> and vision of a <q>prosperous Nation</q>.
        </p>

        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-3xl font-bold mb-4 text-[#9ac531]">Our Focus</h3>
          ...
          <div>
            <h3 className="text-3xl font-bold mb-4 text-[#0757a0]">Our Belief</h3>
        ...
        <blockquote className="border-l-8 border-[#9ac531] pl-8 italic text-xl font-semibold text-[#0757a0] shadow-md bg-[#f0f9e8] rounded-xl p-6 max-w-2xl mx-auto">
