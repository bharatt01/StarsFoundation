      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 items-start">
        ...
        <div className="md:col-span-2 flex flex-col gap-4">
          <div className="flex items-center gap-4">
            ...
            />
            <span className="font-extrabold text-3xl tracking-tight text-[#9ac531] drop-shadow-sm">
              StarsFoundation
            </span>
          </div>
        ...
        {/* QUICK LINKS */}
        <div>
          <h3 className="text-xl font-bold mb-6 text-[#9ac531] uppercase tracking-wider">
            Quick Links
          </h3>
            ...
            {quickLinks.map((link) => (
              <li key={link.label}>
                <button
                  ...
                  className="hover:text-[#9ac531] transition text-left"
                >
                  {link.label}
                </button>
              </li>
        ...
        <div>
          ...
          <ul className="text-base space-y-2 font-semibold">
            ...
            <li>
              Email:{" "}
              <a href="mailto:starsfoundation2018@gmail.com" className="underline hover:text-[#9ac531]">
                starsfoundation2018@gmail.com
              </a>
            </li>
          </ul>
          <div className="flex gap-5 mt-6">
            {/* Social icons remain as <a> for external links */}
            <a
              href="https://instagram.com/starfoundation"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
              className="hover:text-[#9ac531] transition"
            >
